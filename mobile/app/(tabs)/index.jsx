      ...
      <View style={styles.bookDetails}>
        ...
        {item.pdfUrl ? (
          <TouchableOpacity
            ...
            onPress={() => {
              console.log("[Mobile] Opening PDF:", item.pdfUrl);
              if (item.pdfUrl) {
          ...
          >
            ...
            <Text style={{ color: COLORS.white, marginLeft: 8, fontWeight: "600" }}>Read Book</Text>
          </TouchableOpacity>
        ) : null}
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Shivam Books 📚</Text>
